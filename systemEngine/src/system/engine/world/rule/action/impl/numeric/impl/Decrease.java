...
public class Decrease extends AbstractAction implements NumericVerify {

    private String propertyName;
    private String expressionStr;

    public Decrease(EntityDefinition entityDefinitionParam, String propertyNameParam, String expressionStrParam) {
