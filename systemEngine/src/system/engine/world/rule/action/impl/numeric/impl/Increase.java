...
public class Increase extends AbstractAction implements NumericVerify {
    private String propertyName;
    private String expressionStr;

    public Increase(EntityDefinition entityDefinitionParam, String propertyNameParam, String expressionStrParam) {
